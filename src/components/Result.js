        ...
        <div className="result text-white px-4 py-12 md:p-8 block justify-center text-center">
            ...
            </p>
            {
                    ...
                    <div className="flex justify-center">
                {
                    ...
                    <span>on:</span>
                    <div className="flex justify-center">
                        <a className="social md:hidden mx-2 px-4 py-2 bg-green-400" href="whatsapp://send?text=Hurray!!! I just won quiz on nuru-quiz" data-action="share/whatsapp/share">Whatsapp</a>
                        
                        <a className="social mx-2 px-4 py-2 bg-purple-600" href="http://twitter.com/share?text=Hurray!!! I just won quiz on nuru-quiz&url=http://quizgh.netlify.app goes here&hashtags=quizGh,QuizApp">Twitter</a>
                        
                        <a className="social mx-2 px-4 py-2 bg-blue-600" href="https://www.facebook.com/sharer/sharer.php?u=quizgh..netlify.app" target="_blank" rel="noreferrer">Facebook</a>
                    </div>
                </>
            :
            ...
            <button className="text-center btn mx-2 py-2 mt-3 bg-blue-500 text-white bg-blue-600 hover:bg-blue-800 
                rounded-lg font-semibold text-xl w-full md:w-1/2" onClick={() => restartQuiz()}>Start Over</button>
